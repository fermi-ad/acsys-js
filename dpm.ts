        ...
        for await (let ii of replies) {
          ...
          if (msg instanceof DPM_reply_OpenList) {
            ...
            if (errCallback !== undefined)
              ...
              console.info(
                `DPM: error status ${s} for ${this.reqs[msg.ref_id].drf2}`
              );
            }
          } else if (
            ...
            callback({ ref_id, timestamp, data }, dInfo as DeviceInfo);
          } else if (
            ...
            callback({ ref_id, timestamp, data: rest }, dInfo as DeviceInfo);
          }
        }
      } catch (e) {
